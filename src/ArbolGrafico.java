...
public class ArbolGrafico extends JPanel {
    ...
    public void dibujarArbol(Graphics2D g2d, Nodo nodo, int x, int y, int dimensionX, int dimensionY) {
        if (nodo != null) {
            ...
            // Dibuja la línea y llama recursivamente para el primer hijo izquierdo
            ...
            // Dibuja la línea y llama recursivamente para el segundo hijo izquierdo
            ...
            // Dibuja la línea y llama recursivamente para el primer hijo derecho
            if (nodo.derecha1 != null) {
                g2d.drawLine(x, y, x + dimensionX / 2, y + dimensionY);
                dibujarArbol(g2d, nodo.derecha1, x + dimensionX / 2, y + dimensionY, dimensionX / 2, dimensionY);
            }

            // Dibuja la línea y llama recursivamente para el segundo hijo derecho
